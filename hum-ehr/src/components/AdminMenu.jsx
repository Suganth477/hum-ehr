	...
	return (<>
		<li className="active application-menu-list" data-section="dashboard" onClick={() => navigate('/dashboard')}>
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-view-dashboard" />
		...
		<li className="application-menu-list d-none">
			<ul className="nav-pills nav-stacked d-none sub-menu-ul-list sub-menu-1">
				<li className="application-sub-menu1-list sub-menu-list">
					<a href="#" onClick={prevent}>
						<span className="app-menu-icon mdi mdi-account-plus" />
						<span className="app-menu-description wrapped-text">Enroll Patient &amp; Program</span>
					</a>
				</li>
				<li className="application-sub-menu1-list sub-menu-list">
					<a href="#" onClick={prevent}>
						<span className="app-menu-icon mdi mdi-account-injury-outline" />
				...
				<li className="application-sub-menu1-list sub-menu-list" onClick={() => navigate('/patients')}>
					<a href="#" onClick={prevent}>
						<span className="app-menu-icon mdi mdi-hospital-building" />
						<span className="app-menu-description">EHR Patients</span>
					</a>
				</li>
				<li className="application-sub-menu1-list sub-menu-list">
					<a href="#" onClick={prevent}>
						<span className="app-menu-icon mdi mdi-phone-off" />
			...
			<a href="#" className="parent-link" onClick={prevent}>
				...
				<span className="mdi mdi-menu-right app-sub-menu-icon" />
			</a>
		</li>

		<li className="application-menu-list">
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-calendar-account-outline" />
				<span className="app-menu-description">Appointment</span>
			</a>
		</li>

		<li className="application-menu-list" data-section="patients" onClick={() => navigate('/patients')}>
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-account-injury-outline" />
		...
		<li className="application-menu-list" onClick={() => navigate('/message-center')}>
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-message-text-outline" />
		...
		<li className="application-menu-list">
			<a href="#" className="parent-link" onClick={() => navigate('/reports')}>
				<span className="app-menu-icon mdi mdi-file-chart-outline" />
				<span className="app-menu-description">Reports</span>
			</a>
		</li>

		<li className="application-menu-list" data-section="orders" onClick={() => navigate('/orders')}>
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-cart-plus" />
		...
		<li className="application-menu-list">
			<a href="#" className="parent-link" onClick={() => navigate('/referral')}>
				<span className="app-menu-icon">
					<i className="fa-solid fa-people-arrows" style={{ height: '18px', width: '22px' }} />
				</span>
		...
		<li className="application-menu-list">
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-file-sign" />
		...
		<li className="application-menu-list">
			<a href="#" className="parent-link" onClick={prevent}>
				<span className="app-menu-icon mdi mdi-currency-usd" />
		...
		{hasAdministrationAccess() && (<li className="application-menu-list">
			<a href="/usermanagement" className="parent-link" target="_blank" rel="noopener noreferrer">
				<span className="app-menu-icon mdi mdi-application-cog-outline" />
				<span className="app-menu-description wrapped-text">Administration</span>
			</a>
		</li>)}

		<li className="application-menu-list d-none" data-section="help">
			<a href="#" className="parent-link" onClick={() => navigate('/help')}>
				<span className="app-menu-icon mdi mdi-help-circle-outline" />
