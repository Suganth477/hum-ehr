...
const DocumentPreviewModal = ({ visible, fileDetails, onClose }) => {
    ...
    return (<div className="modal fade show d-block" id="patient_chart_document_view_common_xl_modal" tabIndex={-1} role="dialog" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
      <div className="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div className="modal-content shadow border-0">
          <div className="modal-header bg-primary text-white py-2 px-3">
            <h5 className="modal-title" id="patient_chart_document_name_common_modal">
              {mimeType === 'application/pdf' ? 'View Report' : 'View Image'} - {fileName}
            </h5>
