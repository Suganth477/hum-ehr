...
import {
    ...
    mdiImageOutline, mdiInformationOutline, mdiListBoxOutline, mdiLogout, mdiMagnify, mdiMenuClose,
    mdiMenuOpen, mdiMenuRight, mdiMessageTextOutline, mdiMicrophone, mdiMicrophoneOutline, mdiNeedle,
    mdiNoteCheckOutline, mdiPaperclip, mdiPencil, mdiPencilOutline, mdiPhoneOff, mdiPhoneOutline,
    mdiPillMultiple, mdiPlayCircleOutline, mdiPlus, mdiPower, mdiUpload, mdiVideoOutline,
...
const MDI_PATHS = {
    ...
    'mdi-list-box-outline': mdiListBoxOutline, 'mdi-logout': mdiLogout, 'mdi-magnify': mdiMagnify,
